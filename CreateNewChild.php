...
//		}	
		...
		$status = NULL;
		$create_child = "INSERT INTO dbchild (id, first_name, last_name, status, birthday, allergies, guardian_phone, guardian_email) VALUES (0,'$first_name', '$last_name', '$status', '$birthday', '$allergies', '$guardian_phone', '$guardian_email')";
