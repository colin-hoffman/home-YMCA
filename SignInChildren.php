...
<div class="container">
    ...
    <ul class="topnav">
        ...
        <li><a class="active" href="http://localhost/home-YMCA/SignInChildren.php">Sign In Children</a></li>
        <li><a class="gray" href="http://localhost/home-YMCA/SignOutChildren.php">Sign Out Children</a></li>
