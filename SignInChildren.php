...
<div class="container">
    ...
    <ul class="topnav">
        <li><a class="dark" href="#temp">Home</a></li>
        <li><a class="active" href="http://localhost/home-YMCA/checkbox.php">Sign In Children</a></li>
        <li><a class="dark" href="#news">Sign Out Children</a></li>
        <li><a class="gray" href="#contact">View Children Info</a></li>
