...
<body>
<div class="container">
    <div class="title">Sign Out Children</div>
    <div class="content">
	<div class="user-details">
        ...
        <div class="submit-button">
            <input type="submit" name="signOut" value="Sign Out Selected Children">
    ...
    <ul class="topnav">
        ...
        <li><a class="gray" href="SignInChildren.php">Sign In Children</a></li>
        <li><a class="active" href="SignOutChildren.php">Sign Out Children</a></li>
